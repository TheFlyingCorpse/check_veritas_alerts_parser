...
parser.add_argument("--appliance-check", help="What to check: epoch|physical-storage|raid|partitions|fibrechannels|hw|temperatures")
parser.add_argument("--enclosure-check", help="What to check: disks|hw|temperatures")
